...
class Window(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        menu_frame.addAction(FrameListView.MovePreviousFrameAction)
        menu_frame.addAction(FrameListView.MoveNextFrameAction)
...
class FrameListView(QtWidgets.QListView):
    def __init__(self, parent=None):
        ...
        self.__create_move_previous_frame_action()
        self.__create_move_next_frame_action()
    ...
    @property
    def MovePreviousFrameAction(self): return self.actions['MovePreviousFrame']
    @property
    def MoveNextFrameAction(self): return self.actions['MoveNextFrame']
    ...
    def __create_selected_previous_frame_action(self):
        a = QtWidgets.QAction('Selected previous frame')
    ...
    def __create_move_previous_frame_action(self):
        a = QtWidgets.QAction('Move previous frame')
        a.setObjectName('MovePreviousFrame')
        a.setShortcut('Ctrl+Alt+Shift+Left')
#        a.setShortcut('Alt+Shift+Left')
        a.triggered.connect(self.__move_previous_frame)
        self.actions['MovePreviousFrame'] = a
    def __create_move_next_frame_action(self):
        a = QtWidgets.QAction('Move next frame')
        a.setObjectName('MoveNextFrame')
        a.setShortcut('Ctrl+Alt+Shift+Right')
#        a.setShortcut('Alt+Shift+Right')
        a.triggered.connect(self.__move_next_frame)
        self.actions['MoveNextFrame'] = a
